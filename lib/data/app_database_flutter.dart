...
/// Open the app's [AppDatabase] on the Flutter/drift_flutter executor. This is
/// the single local-first store the app runs on; the optional delta-sync layer
/// (PRD #189, Phase 5) replicates it in the background rather than opening a
/// second database.
